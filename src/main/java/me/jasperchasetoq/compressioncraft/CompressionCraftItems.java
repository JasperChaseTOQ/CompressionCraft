...
public class CompressionCraftItems {
    ...
    public static final SlimefunItemStack CC_DECOMPRESSOR_1 = new SlimefunItemStack("CC_DECOMPRESSOR_1", Material.PISTON, "&eBasic CC Decompressor", "", "&7Decompresses blocks", "", LoreBuilder.machine(MachineTier.BASIC, MachineType.MACHINE), LoreBuilder.powerPerSecond(50),LoreBuilder.powerBuffer(250), LoreBuilder.speed(1), "&2CompressionCraft");
    public static final SlimefunItemStack CC_DECOMPRESSOR_2 = new SlimefunItemStack("CC_DECOMPRESSOR_2", Material.PISTON, "&6Average CC Decompressor", "", "&7Decompresses blocks", "", LoreBuilder.machine(MachineTier.AVERAGE, MachineType.MACHINE), LoreBuilder.powerPerSecond(100),LoreBuilder.powerBuffer(500), LoreBuilder.speed(2), "&6CompressionCraft");
    public static final SlimefunItemStack CC_DECOMPRESSOR_3 = new SlimefunItemStack("CC_DECOMPRESSOR_3", Material.PISTON, "&aMedium CC Decompressor", "", "&7Decompresses blocks", "", LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), LoreBuilder.powerPerSecond(150),LoreBuilder.powerBuffer(750), LoreBuilder.speed(3), "&aCompressionCraft");
    public static final SlimefunItemStack CC_DECOMPRESSOR_4 = new SlimefunItemStack("CC_DECOMPRESSOR_4", Material.PISTON, "&2Good CC Decompressor", "", "&7Decompresses blocks", "", LoreBuilder.machine(MachineTier.GOOD, MachineType.MACHINE), LoreBuilder.powerPerSecond(200),LoreBuilder.powerBuffer(1000), LoreBuilder.speed(4), "&2CompressionCraft");
    public static final SlimefunItemStack CC_DECOMPRESSOR_5 = new SlimefunItemStack("CC_DECOMPRESSOR_5", Material.PISTON, "&6Advanced CC Decompressor", "", "&7Decompresses blocks", "",LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), LoreBuilder.powerPerSecond(250),LoreBuilder.powerBuffer(1250), LoreBuilder.speed(5), "&6CompressionCraft");
    public static final SlimefunItemStack CC_DECOMPRESSOR_6 = new SlimefunItemStack("CC_DECOMPRESSOR_6", Material.PISTON, "&4End-Game CC Decompressor", "", "&7Decompresses blocks", "",LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), LoreBuilder.powerPerSecond(300),LoreBuilder.powerBuffer(1500),LoreBuilder.speed(6), "&eCompressionCraft");
