...
public class JcItemDecompressor extends AContainer implements RecipeDisplayItem {


    public JcItemDecompressor(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
