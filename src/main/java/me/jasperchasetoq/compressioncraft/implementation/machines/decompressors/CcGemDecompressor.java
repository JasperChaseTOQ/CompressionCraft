...
public class CcGemDecompressor extends AContainer implements RecipeDisplayItem {


    public CcGemDecompressor(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
